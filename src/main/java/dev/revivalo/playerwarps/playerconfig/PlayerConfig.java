package dev.revivalo.playerwarps.playerconfig;
...
public class PlayerConfig extends YamlConfiguration {
    ...
    public static PlayerConfig getConfig(OfflinePlayer player) {
        ...
        if (!new File(PlayerWarpsPlugin.get().getDataFolder(), "userdata" + File.separator + uuid + ".yml").exists()) {
            return null;
        }
    ...
    public PlayerConfig(UUID uuid) {
        super();
        file = new File(PlayerWarpsPlugin.get().getDataFolder(), "userdata" + File.separator + uuid.toString() + ".yml");
        this.uuid = uuid;
        reload();
    }
