...
public class PlayerConfig extends YamlConfiguration {
    ...
    public static PlayerConfig getConfig(OfflinePlayer player) {
        ...
        if (!new File(Bukkit.getServer().getPluginManager().getPlugin("PlayerWarps").getDataFolder(), "userdata" + File.separator + uuid.toString() + ".yml").exists()) {
            return null;
        }
    ...
    public PlayerConfig(UUID uuid) {
        super();
        file = new File(Bukkit.getServer().getPluginManager().getPlugin("PlayerWarps").getDataFolder(), "userdata" + File.separator + uuid.toString() + ".yml");
        this.uuid = uuid;
        reload();
    }
